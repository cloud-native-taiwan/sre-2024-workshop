...
custom_buckets = [0.1, 0.5, 1, 2, 5, 10, 15, 20, 30, 50, 100]
REQUEST_LATENCY = Histogram('http_request_latency_seconds', 'HTTP request latency', ['method', 'endpoint'], buckets=custom_buckets)
